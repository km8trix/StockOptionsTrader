...
#: with the boosting models (bodies were byte-for-byte identical), now
#: :func:`desks.features.build_training_set`. Kept under the local name so
#: callers (and tests) that import ``_build_training_rows`` are unchanged.
_build_training_rows = feature_lib.build_training_set
